...
export const questions: Question[] = [
  ...
  {
    question:
      "Which of the following is true about context switching in operating systems?",
    options: [
  ...
  {
    question:
      "Which layer in the OSI model is responsible for end-to-end communication?",
    options: [
      "Application Layer",
      "Transport Layer",
      "Network Layer",
